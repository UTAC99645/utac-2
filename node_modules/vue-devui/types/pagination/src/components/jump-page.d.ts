...
}, unknown, {}, {}, import("vue").ComponentOptionsMixin, import("vue").ComponentOptionsMixin, "changeCursorEmit"[], "changeCursorEmit", import("vue").PublicProps, Readonly<ExtractPropTypes<{
    goToText: StringConstructor;
    size: {
        type: PropType<"" | "sm" | "lg">;
        default: string;
